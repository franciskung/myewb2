...
urlpatterns = patterns('profiles.views.profile',
    ...
    url(r'^match/$', 'aprilfools_view', name='profile_fools_view'),
    url(r'^match/edit/$', 'aprilfools_edit', name='profile_fools_edit'),
    url(r'^match/(?P<username>[\w\._-]+)/$', 'aprilfools_view', name='profile_fools_view'),
    url(r'^match/(?P<username>[\w\._-]+)/cheers/$', 'aprilfools_cheers', name='profile_fools_cheers'),

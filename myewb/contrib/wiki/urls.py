...
urlpatterns = patterns('',
    ...
    url(r'^(?P<slug>'+ WIKI_URL_RE +r')/feeds/(?P<feedtype>\w+)/$', views.article_history_feed,
        name='wiki_article_history_feed'),

    url(r'^(?P<slug>'+ WIKI_URL_RE +r')/$', views.view_article,
        name='wiki_article'),

    url(r'^edit/(?P<slug>'+ WIKI_URL_RE +r')/$', views.edit_article,
        name='wiki_edit'),

    url(r'^remove/(?P<slug>'+ WIKI_URL_RE +r')/$', views.remove_article,
        name='wiki_remove_article'),

    url(r'observe/(?P<slug>'+ WIKI_URL_RE +r')/$', views.observe_article,
        name='wiki_observe'),

    url(r'observe/(?P<slug>'+ WIKI_URL_RE +r')/stop/$', views.stop_observing_article,
